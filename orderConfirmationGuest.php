<?php
    ...
    $sql = "SELECT * FROM `order` WHERE `userid` IS NULL ORDER BY `orderid` DESC LIMIT 1";
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="confirmation-section">
                        ...
                        <div class="order-details">
                            <address>
                                <?php echo$orderinfo[4];  ?><br>
                                <?php echo$orderinfo[7];  ?> <br>
                                <?php echo$orderinfo[8];  ?> <br>
                                <?php echo$orderinfo[9];  ?> <br>
